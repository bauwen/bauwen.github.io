assets.createObject("obj_player", {
    ...
    checkRoomTransition: function () {
        ...
        if (ver !== 0) {
            ...
            var nextRm = link[index];
            var currRm = gameloop.room;

            if ((currRm === "rm_grass_village4" && nextRm === "rm_cave1") ||
                (currRm === "rm_cave1" && nextRm === "rm_grass_village4") ||
                (currRm === "rm_cave4" && nextRm === "rm_snow1") ||
                (currRm === "rm_snow1" && nextRm === "rm_cave4")) {
                blackFade = 1.1;
            }
    ...
    playEndScene1: function () {
        ...
        act.start([
            ...
            act.say("Yay! I'm so happy!"),
            act.execSync(function () {
                setTimeout(function () {
                    gameloop.gotoRoom("rm_credits");
                }, 800);
            }),
            act.say(ending2 ? "..." : "WAIT, PLEASE DISCOVER THE TRUTH. GOATLIPS = LOSTAPIG. It's an anagram!"),
