    ...
    onupdate: function () {
        ...
        if (nol.keyboardPressed("enter") && movement.isFacing(playerInstance, this.x, this.y)) {
            ...
            if (!foundSheep) {
                ...
                if (ending3) {
                    act.start([
                        act.say("You should talk to the lady in the desert village.")
                    ]);
                } else {
                    act.start([
        ...
        if (nol.keyboardPressed("enter") && movement.isFacing(playerInstance, this.x, this.y)) {
            ...
            if (ending1 && ending2) {
                act.start([
                    ...
                    act.say("I've seen things you don't want to know...")
                ]);
            } else {
                act.start([
        ...
        if (nol.keyboardPressed("enter") && movement.isFacing(playerInstance, this.x, this.y)) {
            ...
            if (!ending1 || !ending2) {
                ...
                act.start([
                    ...
                    //act.say("..."),
                    act.say("Yes."),
                    act.say("Those pigs you see aren't real pigs. They are actually sheep..."),
                    act.say("I did not expect anyone to discover this. But you did."),
                    act.say("And because of that I must congratulate you."),
                    act.execSync(function () { playSound("snd_bonus"); gameEnd = true; }),
        ...
        if (nol.keyboardPressed("enter") && movement.isFacing(playerInstance, this.x, this.y)) {
            ...
            if (ending2) {
                ...
                act.start([
                    ...
                    act.say("GOAT LIPS!"),
                    act.say("It's an anagram of 3 words!"),
                    act.say("You should be able to use it somewhere!"),
                    act.say("...")
                ], function () {
                    self.rotation = 180;
                });
                                    ...
                                    act.start([
                                        ...
                                        act.ask("What is the meaning of life?", function (yes, cb) {
                                            act.start([
                                                ...
                                                act.say("I do not remember the exact 3 words, but somehow I do remember every single letter in the form of 2 words!"),
                                                act.say("It was something like..."),
                                                act.say("..."),
                                                act.say('"goat lips"'),
                                                act.say("..."),
                                                act.say("The order of the letters are wrong, though."),
                                                act.say("You should be able to use it somewhere!"),
                                                act.say("..."),
